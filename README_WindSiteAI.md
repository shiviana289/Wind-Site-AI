...
### 2. Training Data
Existing wind turbine locations from the US Wind Turbine Database (USWTDB) are used as positive training samples. Random points in non-turbine areas serve as negative samples. Combined into a binary-labeled point dataset.
...
USC B.S. Global GeoDesign (GIS, Spatial Sciences, Urban Planning) — May 2026  
[LinkedIn](#) | [GitHub](#)
